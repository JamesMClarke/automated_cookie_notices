...
addon_info = AddonInfo(
	...
	addon_summary=_("NVDA Web Crawler"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""Crawls websites using NVDA navigation and captures accessibility data.
Saves HTML and NVDA screen reader output to Desktop for accessibility research."""),
	# version
	addon_version="1.0",
	...
	# Author(s)
	addon_author="James Clarke <j.m.clarke@surrey.ac.uk>",
...
pythonSources: list[str] = ["addon/globalPlugins/uia_hook/*.py"]
